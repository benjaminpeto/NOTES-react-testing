...
We mock the fetch request, the test will pass, although as it's an async request, even with the mock data, it will take time to update the title.
On the next chapter, we will see, how we can wait for this data appear on the screen.
